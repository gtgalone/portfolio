...
class Memo extends React.Component {
    ...
    render() {
        ...
        const memoHeader = (
            <div className="container memo-header">
                <div className="card memo-header blue accent-2">
                    <div className="card-content white-text">
                        메 모 장<i className="material-icons">&#xE150;</i>
                    </div>
                </div>
            </div>
        );
        ...
        return (
            <div className="wrapper">
                ...
                {this.props.isLoggedIn ? <Write onPost={this.handlePost}/> : <Write onPost={this.handlePost}/> }
